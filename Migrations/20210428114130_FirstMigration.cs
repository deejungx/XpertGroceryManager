        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PurchaseLineItem_Product_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Product",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PurchaseLineItem_Purchase_PurchaseId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SalesLineItem", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SalesLineItem_Product_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Product",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SalesLineItem_Sales_SalesId",
                        column: x => x.SalesId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SalesLineItem_ProductId",
                table: "SalesLineItem",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_SalesLineItem_SalesId",
                table: "SalesLineItem",
                column: "SalesId");
        }
